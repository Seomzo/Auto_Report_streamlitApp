...
def main():
    ...
    if menu_sales_file is not None and sheet_name and worksheet_name:
        ...
        if st.button("Update Menu Sales in Google Sheet"):
            update_google_sheet(sheet, menu_name_counts, menu_labor_gross_sums, menu_parts_gross_sums, selected_date, start_row=2)  # Adjust start_row as per your sheet layout
